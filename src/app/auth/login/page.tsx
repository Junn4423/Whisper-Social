...
function LoginForm() {
  ...
  const { signIn, signInWithGoogle, language } = useApp();
...
function LoginLoading() {
  return (
    <div className="relative w-full max-w-md">
      <div className="bg-dark-100/50 backdrop-blur-xl rounded-2xl border border-neon-purple/20 p-8 flex items-center justify-center min-h-[400px]">
        <Sparkles className="w-8 h-8 text-neon-purple animate-spin" />
      </div>
    </div>
  );
}
